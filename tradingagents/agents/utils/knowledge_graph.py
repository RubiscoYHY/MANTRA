# This file is vendored from MemPalace (https://github.com/milla-jovovich/mempalace)
# Original author: milla-jovovich
# License: MIT (see THIRD_PARTY_LICENSES.md)
# Vendored to avoid requiring a separate package installation.
"""
